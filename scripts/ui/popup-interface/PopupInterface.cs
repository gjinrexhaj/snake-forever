...
public partial class PopupInterface : Control
{
	...
	public override void _Ready()
	{
		...
		_quitConfirmScreen.Quit += Quit;

	}

	private void Quit()
	{
		GD.Print("QUIT TO MENU");
		StaticEventManager.ReturnToMainMenu?.Invoke();
	}
	...
	private void ResumeGame()
	{
		...
		StaticEventManager.BroadcastResumeGameEvent();
	}
	...
	public override void _UnhandledInput(InputEvent @event)
	{
		...
		if (Input.IsActionJustPressed("pause"))
		{
			...
			StaticEventManager.BroadcastPauseGameEvent();
		}
	}
}
